...
hi Identifier guifg=Green gui=bold ctermfg=Green cterm=bold                             " 関数、識別子
hi Type guifg=Cyan gui=bold ctermfg=Cyan cterm=bold                                     " 型(クラス、構造体)
hi Statement guifg=Magenta gui=bold ctermfg=Magenta cterm=bold                          " 命令、分岐
...
hi Conditional guifg=Magenta gui=bold ctermfg=Magenta cterm=bold                        " if, not
hi Repeat guifg=Magenta gui=bold ctermfg=Magenta cterm=bold                             " for
...
hi ModeMsg guifg=Green gui=none ctermfg=DarkGreen cterm=none                            " --挿入--とかのメッセージ
hi MoreMsg guifg=Magenta gui=none ctermfg=Magenta cterm=none                            " --継続--メッセージ
hi WarningMsg guifg=Yellow gui=none ctermfg=Yellow cterm=none                           " 警告メッセージ
hi ErrorMsg guifg=White guibg=Magenta gui=none ctermfg=White ctermbg=Magenta cterm=none " エラーメッセージ
...
hi Ignore guifg=Magenta guibg=Black ctermfg=Magenta ctermbg=Black
hi Error guifg=White guibg=Magenta ctermfg=White ctermbg=Magenta                        " コマンド実行エラー
